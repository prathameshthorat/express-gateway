...
var _command = require('ioredis/lib/command');

var originalCommands = _interopRequireWildcard(_command);
...
var RedisMock = function (_EventEmitter) {
  ...
  function RedisMock() {
    ...
    Object.keys(commands).forEach(function (command) {
      _this[command] = (0, _command3.default)(commands[command].bind(_this), command, _this);
    });
